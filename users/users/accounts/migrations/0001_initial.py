# Generated by Django 4.1.5 on 2023-01-08 16:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('line', models.TextField(blank=True, null=True, verbose_name='line')),
                ('code', models.CharField(blank=True, max_length=3, validators=[django.core.validators.MaxLengthValidator(4, 'phone code cannot be longer than 4 chars'), django.core.validators.MinLengthValidator(2, 'phone code cannot be shorter than 2 chars')], verbose_name='code')),
